...
class Trainer_Main(BaseTrainer):
    
    def __init__(self, args):
        super(Trainer_Main,self).__init__(args)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(tqdm(train_loader,desc='iter',leave=False,ncols=100)):
                iter_count += 1
